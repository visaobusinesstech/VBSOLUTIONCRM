...
export function EmailTemplates({ isCreating, onCreatingChange }: EmailTemplatesProps) {
  const { user } = useAuth();
  ...
  const handleSaveTemplate = async () => {
    ...
    try {
      const templateData = {
        ...
        assinatura: null // Usar signature_image ao invés de texto
      };
  ...
  const renderPreview = () => {
    ...
    // Substituir variáveis padrão para preview
