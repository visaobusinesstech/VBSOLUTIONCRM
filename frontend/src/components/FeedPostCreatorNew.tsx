...
import { Image as ImageIcon, Video, Calendar, Send, Plus } from 'lucide-react';
import { useAuth } from '@/contexts/AuthContext';
import { CreateFeedPostData } from '@/types/feed';
import MediaUploadModalNew from './MediaUploadModalNew';

interface FeedPostCreatorNewProps {
  onCreatePost: (postData: CreateFeedPostData) => void;
}

const FeedPostCreatorNew = ({ onCreatePost }: FeedPostCreatorNewProps) => {
  const { user } = useAuth();
  ...
  const handleMediaPost = (postData: CreateFeedPostData) => {
...
export default FeedPostCreatorNew;
