...
const ActivityForm = ({ companies, employees, projects = [], onSubmit, initialData }: ActivityFormProps) => {
  ...
  const projectItems = createSafeSelectItems(
    (projects || []).filter(project => project && project.id && project.name),
    (project) => project.id,
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <Select value={formData.project_id} onValueChange={(value) => setFormData({ ...formData, project_id: value })}>
          ...
          <SelectContent>
            <SafeSelectItem value="">Sem projeto</SafeSelectItem>
