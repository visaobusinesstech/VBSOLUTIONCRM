// Script para executar SQL no Supabase - Tentativa 8
const https = require('https');

console.log('🎯 Executando SQL no Supabase - Tentativa 8...');
...
async function executeSQLSupabase8() {
    try {
        ...
        if (migrationResult.status === 200) {
            console.log('✅ Tabela pipelines criada via supabase_migrate_custom');
            ...
            console.log('❌ Erro ao executar supabase_migrate_custom:', migrationResult.data);
            return false;
        }
...
executeSQLSupabase8().then(success => {
    if (success) {
        console.log('\n✅ Configuração concluída com sucesso!');
        console.log('🚀 Agora você pode testar o gerenciamento de pipelines');
    } else {
        console.log('\n❌ Tentativa 8 falhou, tentando método alternativo...');
    }
});
