...
-- 7. Verificar dados
SELECT 'Pipelines criadas:' as status;
SELECT name, is_default, is_active FROM public.pipelines;

SELECT 'Etapas atualizadas:' as status;
SELECT name, pipeline_id IS NOT NULL as has_pipeline FROM public.funnel_stages ORDER BY position;
