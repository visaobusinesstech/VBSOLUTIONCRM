...
// Função principal para enviar email via SMTP
      ...
      try {
        await supabase
          ...
          .insert([{
            ...
            contato_tipo: emailData.contato_tipo || 'contact',
            contato_nome: emailData.contato_nome,
            contato_email: emailData.to,
        ...
        console.log('📝 Registro salvo no histórico');
      } catch (historyError) {
...
serve(async (req) => {
  ...
  // Handle CORS preflight requests - CORRIGIDO PARA GARANTIR STATUS 200
